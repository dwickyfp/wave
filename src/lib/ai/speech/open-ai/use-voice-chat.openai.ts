...
export function useOpenAIVoiceChat(props?: VoiceChatOptions): VoiceChatSession {
  ...
  const sendVoiceTurn = useCallback(
    ...
    [clearSpeechTimeout, finishAgentTurn, sendMessage, setListeningState],
  );
