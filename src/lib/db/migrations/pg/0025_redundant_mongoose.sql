CREATE TABLE "llm_model_config" (
	...
	"model_type" varchar DEFAULT 'llm' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "chat_thread" ALTER COLUMN "snowflake_parent_message_id" SET DATA TYPE bigint;--> statement-breakpoint
ALTER TABLE "llm_model_config" ADD CONSTRAINT "llm_model_config_provider_id_llm_provider_config_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."llm_provider_config"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
